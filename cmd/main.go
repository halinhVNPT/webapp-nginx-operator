...
import (
	...
	"vnptplatform.vn/webapp-example/internal/controller"
...
func main() {
	...
	mgr, err := ctrl.NewManager(ctrl.GetConfigOrDie(), ctrl.Options{
		...
		LeaderElectionID:       "82a3242b.vnptplatform.vn",
	...
	if err := (&controller.NginxWebAppReconciler{
		Client: mgr.GetClient(),
		Scheme: mgr.GetScheme(),
	}).SetupWithManager(mgr); err != nil {
		setupLog.Error(err, "unable to create controller", "controller", "NginxWebApp")
		os.Exit(1)
	}
